...
class SquareUniqueGrid_Tester(unittest.TestCase):
    def setUp(self):
        ...
        self.XYs = gpd.GeoDataFrame({"geometry": gpd.points_from_xy(x, y)})
...
class SquareRandomGrid_Tester(unittest.TestCase):
    def setUp(self):
        ...
        self.grid_assignment = np.array(
            [[2, 4, 2, 1], [3, 2, 3, 1], [1, 0, 1, 1], [0, 0, 1, 3]]
        )
...
test_classes = [
    SquareUniqueGrid_Tester,
    SquareRandomGrid_Tester,
    SquareSystematicGrid_Tester,
]
